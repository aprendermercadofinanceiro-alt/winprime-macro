...
(function () {
  ...
  // Troca de token depois: no Investing, tecle Ctrl+Shift+K.
  ...
  // ---- Overlay do placar (canto superior direito) ----
  const box = document.createElement("div");
  box.style.cssText = "position:fixed;top:12px;right:12px;z-index:2147483000;background:#0f130c;color:#f2f2ec;font:13px Arial;padding:12px 14px;border-radius:10px;box-shadow:0 6px 24px rgba(0,0,0,.4);min-width:220px;border:1px solid #2a3222";
  box.innerHTML = "<b style='color:#b7e08c'>WINPRIME</b><br><small>iniciando…</small>";
  document.body.appendChild(box);

  function pintar(p, res) {
    ...
    else if (res.status === 401 || res.status === 403) status = "token invalido ✗ (Ctrl+Shift+K p/ trocar)";
  ...
  // ---- Caixa VISIVEL para colar o token (dentro da propria pagina) ----
  function pedirToken() {
    ...
    w.innerHTML =
      "<div style='background:#0f130c;color:#f2f2ec;padding:26px;border-radius:14px;max-width:440px;width:90%;border:1px solid #2a3222;box-shadow:0 12px 48px rgba(0,0,0,.6)'>" +
        ...
        "<div style='font-size:13px;color:#cfd6c6;margin-bottom:14px;line-height:1.5'>Cole abaixo o seu <b>token do GitHub</b> (começa com <code>github_pat_</code>).<br>Ele fica salvo <b>somente no seu navegador</b> e nunca sai daqui.</div>" +
